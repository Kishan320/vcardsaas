                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl shadow-card p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <TextInput v-model="form.name" type="text" class="mt-1.5" placeholder="Pro Plan" :has-error="!!form.errors.name" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <TextInput v-model="form.price" type="number" step="0.01" class="mt-1.5" placeholder="29.99" :has-error="!!form.errors.price" />
                                <InputError :message="form.errors.price" />
                            </div>
                            <div>
                                <InputLabel value="Yearly Price ($)" />
                                <TextInput v-model="form.yearly_price" type="number" step="0.01" class="mt-1.5" placeholder="Auto-calculated if empty" />
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl shadow-card p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            <div>
                                ...
                                <TextInput v-model="form.business" type="number" class="mt-1.5" placeholder="5" :has-error="!!form.errors.business" />
                                <InputError :message="form.errors.business" />
                            </div>
                            <div>
                                <InputLabel value="Max Users" required />
                                <TextInput v-model="form.max_users" type="number" class="mt-1.5" placeholder="3" :has-error="!!form.errors.max_users" />
                                <InputError :message="form.errors.max_users" />
                            </div>
                            <div>
                                <InputLabel value="Bio Links" required />
                                <TextInput v-model="form.bio_links" type="number" class="mt-1.5" placeholder="10" :has-error="!!form.errors.bio_links" />
                                <InputError :message="form.errors.bio_links" />
                            </div>
                            <div>
                                <InputLabel value="Storage (GB)" required />
                                <TextInput v-model="form.storage_limit" type="number" class="mt-1.5" placeholder="5" :has-error="!!form.errors.storage_limit" />
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl shadow-card p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            ...
                            <div v-if="trialEnabled">
                                ...
                                <TextInput v-model="form.trial_day" type="number" class="mt-1.5" placeholder="7" />
                            </div>
                            <div class="flex items-center gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="checkbox" v-model="form.is_default" id="is_default" class="rounded border-gray-300 accent-[var(--theme-color)]" />
...
const form = useForm({
    ...
    features: {
        ...
        bio_link: false,
        business_template_sections: [] as string[],
    } as Record<string, any>,
    is_trial: 'off' as string,
    trial_day: '',
    is_plan_enable: 'on' as string,
    is_default: false,
});
